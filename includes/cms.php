...
function cms_defaults(): array
{
    return [
        ...
        'sandra' => [
            ...
            'p_3' => 'Sandra wird schrittweise um weitere Regionen, Funktionen und verlässliche lokale Informationen ergänzt.',
        ],
        'contact' => [
            'title' => 'Kontakt',
        ...
        'legal' => [
            ...
            'imprint_body' => 'Angaben gemäß den jeweils anwendbaren gesetzlichen Vorschriften. Die tatsächlichen Unternehmens- und Registrierungsdaten müssen vor der Veröffentlichung rechtlich geprüft werden.',
            'company' => 'Thailand Insight Group Co., Ltd.',
            'address' => "Vollständige ladungsfähige Anschrift vor Veröffentlichung ergänzen.",
            ...
            'privacy_body' => 'Personenbezogene Daten werden nur verarbeitet, soweit dies für den Betrieb der Website, die Bearbeitung von Kontaktanfragen oder die Bereitstellung gebuchter Leistungen erforderlich ist. Kontaktformular-Nachrichten werden auf dem Hosting-Server gespeichert und dürfen nur durch autorisierte Betreiber eingesehen werden. Die endgültige Datenschutzerklärung muss vor Veröffentlichung an Hosting, E-Mail, Zahlungs- und Analysedienste angepasst und rechtlich geprüft werden.',
        ],
        'topics' => [
            ...
            'norden' => ['title' => 'Norden', 'image' => 'assets/img/north-premium.jpg', 'text' => 'Berge, Natur, Kultur und traditionsreiche Städte machen den Norden zu einer besonderen Thailand-Region. Chiang Mai, Chiang Rai und die Berglandschaften eignen sich für Tempel, Märkte, Trekking und ein kühleres Klima in den Wintermonaten.'],
            'sueden-inseln' => ['title' => 'Süden & Inseln', 'image' => 'assets/img/south-premium.jpg', 'text' => 'Tropische Inseln, Strände und die Küsten am Golf von Thailand und an der Andamanensee. Phuket, Koh Samui, Krabi und die kleineren Inseln stehen für Meer, Felsen, Schnorcheln und lange Abende am Strand.'],
